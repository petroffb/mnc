...
где
ip-сервера			- IPv4-адресс локального сервера
...
last CPU core			- порядковый номер последнего ядра для использования орловским софтом

PS. Указание всех ключей обязательно.